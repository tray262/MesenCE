...
{
	public partial class PcEngineConfig : BaseConfig<PcEngineConfig>
	{
		...
		[ObservableProperty] public partial ControllerConfig Port1A { get; set; } = new();
		[ObservableProperty] public partial ControllerConfig Port1B { get; set; } = new();
		[ObservableProperty] public partial ControllerConfig Port1C { get; set; } = new();
		[ObservableProperty] public partial ControllerConfig Port1D { get; set; } = new();
		[ObservableProperty] public partial ControllerConfig Port1E { get; set; } = new();

		[ObservableProperty] public partial bool AllowInvalidInput { get; set; } = false;
		[ObservableProperty] public partial bool PreventSelectRunReset { get; set; } = true;

		[ObservableProperty] public partial PceConsoleType ConsoleType { get; set; } = PceConsoleType.Auto;
		...
		[ObservableProperty][MinMax(0, 100)] public partial UInt32 CdAudioVolume { get; set; } = 100;
		[ObservableProperty][MinMax(0, 100)] public partial UInt32 AdpcmVolume { get; set; } = 100;
		[ObservableProperty] public partial bool UseHuC6280aAudio { get; set; } = true;
		...
		[ObservableProperty] public partial bool DisableSpritesVdc2 { get; set; } = false;
		[ObservableProperty] public partial bool DisableBackground { get; set; } = false;
		[ObservableProperty] public partial bool DisableBackgroundVdc2 { get; set; } = false;
		...
		[ObservableProperty] public partial OverscanConfig Overscan { get; set; } = new() { Top = 3, Left = 18, Right = 18 };

		[ObservableProperty] public partial UInt32[] Palette { get; set; } = PcEngineConfig.DefaultPalette.ToArray();
